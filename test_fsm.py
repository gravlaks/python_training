...
def main():
    ...
    task_1_config = {"fnc": read_uart, "args": (), "periodic": True, "period": 0.1, "trace_dependent": False, "entry_states": ("init", "griffin_turning_on", "griffin_started"), "end_state": "no_change"}
    task_2_config = {"fnc": griffin_on, "args": (), "periodic": False, "execution_time":2, "trace_dependent": False, "entry_states": ("init"), "end_state": "griffin_turning_on"}
    task_3_config = {"fnc": check_for_starting, "args": (), "periodic": True, "period": 0.5, "trace_dependent": True, "entry_states": ("griffin_turning_on"), "end_state": "return_value"}
